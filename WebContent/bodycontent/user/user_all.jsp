...
<a href="<s:url value="/admin/user/new"/>">Add New User</a>
<br>
<s:if test="userAllList.size()>0">
	<s:iterator value="userAllList" status="courseStatus">
		<div class="panel panel-info">
		  <div class="panel-heading"><a href="<s:url value="/user/findByUserId"/><s:property value="user_id"/>"><s:property value="name" /></a></div>
		  <div class="panel-body">
		  	<div>
		    	...
		    	<s:else>
					...
					<a href="${activeUser }"><i
									class="glyphicon glyphicon-plus"></i><font color="green">Active</font></a>
			    </s:else>
		  	</div>
		  </div>
		</div>
